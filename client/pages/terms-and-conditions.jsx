...
const TermsAndConditions = () => {
  return (
    <section className="mx-auto max-w-7xl py-8 px-4">
      <h1 className="py-6 text-3xl">Terms and Conditions</h1>
      <p>Last updated: February 06, 2021</p>
      <p>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h1 className="py-6 text-3xl">Interpretation and Definitions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Tadashi.
          </p>
        </li>
        <li>
          <p>
      ...
      <h1 className="py-6 text-3xl">Acknowledgment</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Links to Other Websites</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Termination</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Limitation of Liability</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">"AS IS" and "AS AVAILABLE" Disclaimer</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Governing Law</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 className="py-6 text-3xl">United States Legal Compliance</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Severability and Waiver</h1>
      <h2>Severability</h2>
      <p>
      ...
      <h1 className="py-6 text-3xl">Translation Interpretation</h1>
      <p>
      ...
      <h1 className="py-6 text-3xl">Changes to These Terms and Conditions</h1>
      <p>
