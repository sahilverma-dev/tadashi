    ...
    <section className="mx-auto max-w-7xl py-8 px-4">
      ...
      <ul className="list-disc pl-6">
        ...
        <li>
          ...
          “Us” or “Our” in this Agreement) refers to Tadashi IO, Unated States,
          Alaska. For the purpose of the GDPR, the Company is the Data
          Controller.
        </li>
        <li>
      ...
      <h2 className="py-4 text-3xl">Collecting and Using Your Personal Data</h2>
      ...
      <ul className="list-disc pl-6">
        <li>
          ...
          third party vendor, uses cookies to serve ads on our Service. Google’s
          use of the DoubleClick cookie enables it and its partners to serve ads
          to our users based on their visit to our Service or other websites on
          the Internet. You may opt out of the use of the DoubleClick Cookie for
