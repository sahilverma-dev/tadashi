  ...
  return (
    <Layout title="Privacy Policy" description="Privacy Policy of Tadashi">
      <section class Name="mx-auto max-w-7xl py-8 px-4">
        ...
        <h2 className="py-4 text-3xl">Interpretation and Definitions</h2>
        <h3 className="py-2 text-xl">Interpretation</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Definitions</h3>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            ...
            “Us” or “Our” in this Agreement) refers to Tadashi IO, Unated
          ...
          <li>
            <strong>Website</strong> refers to Tadashi, accessible from{" "}
            <Link href="/">
              <a className="underline hover:text-blue-500">Tadashi</a>
            </Link>
          </li>
          <li>
        ...
        <h3 className="py-2 text-xl">Types of Data Collected</h3>
        <h4>Personal Data</h4>
        <p>
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            prevent fraudulent use. Without these Cookies, the services that You
          ...
          <li>
            ...
            used to track information about traffic to the Website and how users
            use the Website. The information gathered via these Cookies may
            directly or indirectly identify you as an individual visitor. This
            is because the information collected is typically linked to a
            pseudonymous identifier associated with the device you use to access
            the Website. We may also use these Cookies to test new pages,
            features or new functionality of the Website to see how our users
            react to them.
          </li>
          <li>
        ...
        <h3 className="py-2 text-xl">Use of Your Personal Data</h3>
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            ...
            offer that are similar to those that you have enquired about unless
        ...
        <h3 className="py-2 text-xl">Retention of Your Personal Data</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Transfer of Your Personal Data</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Disclosure of Your Personal Data</h3>
        ...
        <h3 className="py-2 text-xl">Security of Your Personal Data</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Analytics</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Advertising</h3>
        <p>
        ...
        <ul className="list-disc pl-6">
          <li>
            <strong>Google AdSense &amp; DoubleClick Cookie</strong> Google, as
            a third party vendor, uses cookies to serve ads on our Service.
        ...
        <h3 className="py-2 text-xl">Email Marketing</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Payments</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Behavioral Remarketing</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Usage, Performance and Miscellaneous</h3>
        <p>
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            Device for security purposes. The information gathered by reCAPTCHA
        ...
        <h2 className="py-4 text-3xl">GDPR Privacy</h2>
        ...
        <h3 className="py-2 text-xl">Your Rights under the GDPR</h3>
        <p>
        ...
        <h2 className="py-4 text-3xl">CCPA Privacy</h2>
        <h3 className="py-2 text-xl">Your Rights under the CCPA</h3>
        <p>
        ...
        <h3 className="py-2 text-xl">Do Not Sell My Personal Information</h3>
        <p>
        ...
        <h2 className="py-4 text-3xl">Links to Other Websites</h2>
        <p>
        ...
        <h2 className="py-4 text-3xl">Changes to this Privacy Policy</h2>
        <p>
        ...
        <h2 className="py-4 text-3xl">Contact Us</h2>
        <p>
        ...
        <ul className="list-disc pl-6">
          <li>
            ...
            <Link href="/contact">
              <a className="underline hover:text-blue-500">Contact</a>
            </Link>
          </li>
        </ul>
      </section>
